...
public  class Action extends BaseClass  {
	...
	/*
	 * public static boolean JSClick(WebDriver driver, WebElement ele) { boolean flag =
	...
	/*
	 * public static boolean switchToFrameByIndex(WebDriver driver,int index) { boolean
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "D:\\Workspace2\\MyStoreProject2\\ScreenShots" + filename + "_"
				+ dateName + ".png";
